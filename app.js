      ...
      var fe = lt((fu) => {
        ...
        function Bl(A, o, e) {
          ...
          if (A && A.defaultProps)
            for (t in ((l = A.defaultProps), l)) n[t] === void 0 && (n[t] = l[t]);
...
` + n[g].replace(' at new ', ' at ');
      ...
      function vB(A) {
        var o = A.type;
        return (
          (A = A.nodeName) && A.toLowerCase() === 'input' && (o === 'checkbox' || o === 'radio')
        );
      }
      function da(A) {
      ...
      function sl(A, o, e) {
        if (o.hasOwnProperty('value') || o.hasOwnProperty('defaultValue')) {
          var t = o.type;
          if (!((t !== 'submit' && t !== 'reset') || (o.value !== void 0 && o.value !== null)))
            return;
      ...
      function Hr(A, o) {
        if (o) {
          if (sa[A] && (o.children != null || o.dangerouslySetInnerHTML != null))
            throw Error(c(137, A));
      ...
      function ml(A, o) {
        ...
        for (var t; e; ) {
          if (e.nodeType === 3) {
            if (((t = A + e.textContent.length), A <= o && t >= o))
              return { node: e, offset: o - A };
            A = t;
          }
          A: {
            for (; e; ) {
...
`,
      ...
      function sQ(A) {
        ...
        function r(i, Q, K) {
          ...
          if (((K = i.alternate), K !== null))
            return ((K = K.index), K < Q ? ((i.flags |= 2), Q) : K);
          return ((i.flags |= 2), Q);
        }
        function g(i) {
        ...
        function P(i, Q, K, d) {
          for (
            var H = null, k = null, v = Q, S = (Q = 0), L = null;
            v !== null && S < K.length;
            S++
          ) {
      ...
      function rn(A, o, e, t) {
        ...
        if (l !== null) {
          ...
          u !== null &&
            ...
            (l = u.lastBaseUpdate),
            l !== g &&
              (l === null ? (u.firstBaseUpdate = C) : (l.next = C), (u.lastBaseUpdate = B)));
        }
        if (r !== null) {
          var f = n.baseState;
          ((g = 0), (u = C = B = null), (l = r));
      ...
      function mC(A, o, e) {
        ...
        if (EQ(A)) RQ(o, n);
          ...
          if (
            A.lanes === 0 &&
            (r === null || r.lanes === 0) &&
            ((r = o.lastRenderedReducer), r !== null)
          )
            try {
...
` +
          ...
          case 6:
            if (A && o.stateNode != null) ef(A, o, A.memoizedProps, t);
              ...
              if (((e = Do(qe.current)), Do(hA.current), Gt(o))) {
                if (
                  ((t = o.stateNode), (e = o.memoizedProps), (t[ZA] = o), (r = t.nodeValue !== e))
                ) {
                  if (((A = CA), A !== null))
                    switch (A.tag) {
                      case 3:
          ...
          case 13:
            ...
            return (
              ...
              t !== (A !== null && A.memoizedState !== null) &&
                ...
                ((o.child.flags |= 8192),
                (o.mode & 1) !== 0 &&
                  (A === null || (w.current & 1) !== 0 ? W === 0 && (W = 3) : Lg())),
                      ...
                      if (P !== null) {
                        var { memoizedProps: s, memoizedState: N } = P,
                          ...
                          Q = i.getSnapshotBeforeUpdate(
                            o.elementType === o.type ? s : jA(o.type, s),
                            N,
                          );
          ...
          case 22:
            if (
              ...
              if (
                ...
                (A.stateNode.isHidden = C) && !u && (A.mode & 1) !== 0)
              )
      ...
      function lf(A, o, e) {
        for (var t = (A.mode & 1) !== 0; D !== null; ) {
          ...
          if (n.tag === 22 && t) {
            ...
            (n.subtreeFlags & 8772) !== 0 && r !== null ? ((r.return = n), (D = r)) : iB(A, o, e);
        }
      }
      function iB(A) {
        for (; D !== null; ) {
                  ...
                  case 1:
                    ...
                    if (o.flags & 4 && !AA)
                      if (e === null) t.componentDidMount();
                        ...
                        var n =
                          o.elementType === o.type ? e.memoizedProps : jA(o.type, e.memoizedProps);
      ...
      function ei(A, o, e) {
        ...
        (t !== null && t.delete(o),
          ...
          T === A &&
            (b & e) === e &&
            (W === 4 || (W === 3 && (b & 130023424) === b && 500 > I() - Eg)
              ? Ho(A, 0)
              : (Ig |= e)),
          fA(A, o));
      }
                  ...
                  if (l) {
                    for (g in l)
                      !l.hasOwnProperty(g) ||
                        ...
                        (e || (e = {}), (e[g] = ''));
                    for (g in B)
                      B.hasOwnProperty(g) && l[g] !== B[g] && (e || (e = {}), (e[g] = B[g]));
      ...
      function mf(A, o, e) {
        ...
        if (A && A.defaultProps)
          for (t in ((o = A.defaultProps), o)) n[t] === void 0 && (n[t] = o[t]);
        ...
        return (
          Of.useEffect(() => {
            let A = window,
              o = {
                affiliateLinks: {
                  T1: 'https://ton.com.br/checkout/cart/?productId=TONMEGA_TIER_D150&referrer=7A88DBD6-E80F-497E-80B9-8F5DC95EA9D3&userAnticipation=0&userTag=tonmega_tier&utm_medium=invite_share&utm_source=revendedor&coupon=TON5',
                  'T1 Essencial':
                    'https://ton.com.br/checkout/cart/?productId=TONMEGA_TIER_D150&referrer=7A88DBD6-E80F-497E-80B9-8F5DC95EA9D3&userAnticipation=0&userTag=tonmega_tier&utm_medium=invite_share&utm_source=revendedor&coupon=TON5',
                  T2: 'https://ton.com.br/checkout/cart/?productId=TONMEGA_TIER_D195&referrer=7A88DBD6-E80F-497E-80B9-8F5DC95EA9D3&userAnticipation=0&userTag=tonmega_tier&utm_medium=invite_share&utm_source=revendedor&coupon=TON5',
                  'T2+':
                    'https://ton.com.br/checkout/cart/?productId=TONMEGA_TIER_D195&referrer=7A88DBD6-E80F-497E-80B9-8F5DC95EA9D3&userAnticipation=0&userTag=tonmega_tier&utm_medium=invite_share&utm_source=revendedor&coupon=TON5',
                  'T2+ Mais Vendida':
                    'https://ton.com.br/checkout/cart/?productId=TONMEGA_TIER_D195&referrer=7A88DBD6-E80F-497E-80B9-8F5DC95EA9D3&userAnticipation=0&userTag=tonmega_tier&utm_medium=invite_share&utm_source=revendedor&coupon=TON5',
                  T3: 'https://ton.com.br/checkout/cart/?productId=TONMEGA_TIER_S920&referrer=7A88DBD6-E80F-497E-80B9-8F5DC95EA9D3&userAnticipation=0&userTag=tonmega_tier&utm_medium=invite_share&utm_source=revendedor&coupon=TON5',
                  'T3 Smart':
                    'https://ton.com.br/checkout/cart/?productId=TONMEGA_TIER_SMART_POS&referrer=7A88DBD6-E80F-497E-80B9-8F5DC95EA9D3&userAnticipation=0&userTag=tonmega_tier&utm_medium=invite_share&utm_source=revendedor&coupon=TON5',
                },
                googleSheetsWebhook:
            ...
            ((A.startFlow = C),
              ...
              (A.sendQuick = (u) => {
                ...
                if (U.includes('falar') && U.includes('zap')) {
                  (A.notificarOtavio(),
                    A.addBotMsg('Pode me chamar lá que eu te ajudo! \uD83D\uDC9A'));
                  return;
                }
                if (t === 'categoria')
                  ((e.categoria = f),
                  ...
                  if (
                    f.toLowerCase().includes('já garanti') ||
                    f.toLowerCase().includes('comprovante')
                  )
                    A.handleJaGaranti();
              ...
              (A.sendChat = () => {
                ...
                if (t === 'categoria')
                  ...
                  (A.addBotMsg(
                    'Me conta mais que eu te ajudo a escolher a Ton ideal! \uD83D\uDC47',
                  ),
                    A.setQuickButtons(['T1 Essencial', 'T2+ Mais Vendida', 'T3 Smart']));
              }),
              (A.salvarNoSheets = () => {
...
Whats cliente: ${e.whatsapp || ''}`,
      ...
      `),
          ...
          j('div', {
            className:
              'min-h-screen bg-[#0A0F14] text-white selection:bg-[#00FF88] selection:text-black',
            children: [
              F('link', {
      ...
      `,
              ...
              F('header', {
                className:
                  'sticky top-0 z-40 border-b border-white/5 bg-[#0A0F14]/80 backdrop-blur-xl',
                children: j('div', {
                  className:
                    'mx-auto flex max-w-[1180px] items-center justify-between px-5 py-3 lg:px-8',
                  children: [
                    j('div', {
              ...
              F('section', {
                ...
                children: j('div', {
                  className:
                    'flex flex-col lg:flex-row gap-10 lg:gap-8 items-start lg:items-center',
                  children: [
                    j('div', {
                    ...
                    F('div', {
                      className:
                        'flex-1 w-full relative lg:pl-8 overflow-hidden lg:overflow-visible',
                      children: j('div', {
                        ...
                        children: [
                          ...
                          j('div', {
                            ...
                            children: [
                              F('div', {
                                className:
                                  'text-[11px] font-bold opacity-60 uppercase tracking-widest',
                ...
                children: [
                  j('div', {
                    ...
                    children: [
                      j('h2', {
                        className:
                          'text-[28px] lg:text-[40px] font-black tracking-tight leading-[1.05]',
                        children: [
                          'Por que a Ton tem a ',
                      ...
                      children: [
                        j('div', {
                          ...
                          children: [
                            F('div', {
                              className:
                                'text-[11px] tracking-widest uppercase text-white/40 font-bold',
                            ...
                            F('div', {
                              ...
                              children:
                                'Ideal para começar, cabe no bolso, bateria dura o dia todo.',
                            }),
                            j('ul', {
                        ...
                        j('div', {
                          ...
                          children: [
                            ...
                            F('div', {
                              className: 'mt-2 text-[13px] text-white/60',
                              children:
                                'Imprime comprovante, Pix na tela, 0,57% garantido com Otávio.',
                            }),
                            j('ul', {
                        ...
                        j('div', {
                          ...
                          children: [
                            ...
                            F('div', {
                              className: 'mt-2 text-[13px] text-white/60',
                              children:
                                'Android, apps, gestão completa. Parece um celular premium.',
                            }),
                            j('ul', {
                              className: 'mt-6 space-y-2 text-[13px] text-white/70',
                              children: [
                    ...
                    children: [
                      ...
                      j('div', {
                        ...
                        children: [
                          ...
                          j('p', {
                            className:
                              'mt-3 text-[14px] leading-relaxed text-white/70 max-w-[720px]',
                            children: [
              ...
              j('footer', {
                ...
                children: [
                    ...
                    children: [
                      j('div', {
                        children: [
                          ...
                          F('div', {
                            className: 'mt-1',
                            children:
                              'Representante Oficial Ton em Pelotas / RS • Taxa 0,57% garantida',
                          }),
                          F('div', {
                            className: 'mt-2',
                      ...
                      F('div', {
                        ...
                        children: F('a', {
                          ...
                          rel: 'noopener',
                          className:
                            'rounded-full bg-white text-black px-4 py-2 font-bold text-[12px]',
                  ...
                  F('div', {
                    className:
                      'mt-8 border-t border-white/5 pt-6 text-[11px] leading-relaxed opacity-60',
                    children:
